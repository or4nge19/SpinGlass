...
omit [Nonempty α] [MeasurableSpace α] [MeasurableSingletonClass α]
  [MeasurableSpace β] [MeasurableSingletonClass β] in
...
theorem map_fst_gibbsMeasure_eq_gibbsMeasure_marginalEnergy (H : EnergySpace (α × β)) :
  ...
  have hLHS :
    ...
    simp [FiniteGibbs.gibbsMeasure, gibbsPMF, Fintype.sum_prod_type, Set.indicator]
  ...
  have hRHS :
    ...
    simp [FiniteGibbs.gibbsMeasure, gibbsPMF, Set.indicator]
